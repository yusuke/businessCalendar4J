...
class BusinessHoursTest {
    ...
    void businessHour24h() {
        final UnitedStatesHolidays build = UnitedStatesHolidays.newBuilder().build();
    ...
    void businessHourFrom9to18() {
        // opens 9, closes 18
        final UnitedStatesHolidays build = UnitedStatesHolidays.newBuilder()
    ...
    void fromShouldBeforeTo() {
        assertThrows(IllegalArgumentException.class, () -> UnitedStatesHolidays.newBuilder()
    ...
    void hourShouldBe0to24() {
        assertDoesNotThrow(() -> {
            UnitedStatesHolidays.newBuilder()
    ...
    void nextBusinessHour() {
        ...
        }
        {
            ...
            final UnitedStatesHolidays build = UnitedStatesHolidays.newBuilder().holiday(UnitedStatesHolidays.INDEPENDENCE_DAY).build();
        ...
        {
            // 2021/7/4 and 2021/7/5 are holiday
            final UnitedStatesHolidays build = UnitedStatesHolidays.newBuilder().holiday(UnitedStatesHolidays.INDEPENDENCE_DAY)
